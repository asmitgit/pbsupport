...
//   mc.query("SELECT * FROM userdata WHERE email = ? and password=?", [email,password], function (error, results, fields) {
...
//         }
//         else{
//           return res.send({ error: false, data: null, message: 'Incorrect User/Password',token: null });
//         }
