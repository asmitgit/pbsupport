                            ...
                            if (!data.error) {
                                ...
                                if ($scope.TicketDetails[0].StatusID != $scope.Selected.Status.StatusID) {
                                    var _objNoti = [{
                                        ...
                                        "url": "http://pbsupport.policybazaar.com/home.html#/pbsupport/MyTicketDetails/" + $scope.TicketDetails[0].TicketID,
                                ...
                                if (!data.error) {
                                    ...
                                    if ($scope.TicketDetails[0].IsSupport == 0 && $scope.IsSupport == 1) {
                                        var _objNoti = [{
                                            ...
                                            "entID": $scope.TicketDetails[0].TicketDispID,
                                            "url": "http://pbsupport.policybazaar.com/home.html#/pbsupport/TicketDetails/" + $scope.TicketDetails[0].TicketID,
