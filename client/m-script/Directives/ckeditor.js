...
TicketSystem.directive('ngCkeditor', ['$timeout', function ($timeout) {
    ...
    CKEDITOR.on('instanceCreated', function (event) {
        ...
        if (element.getAttribute('class') == 'simpleEditor') {
            editor.on('configLoaded', function () {
                ...
                element.disableNativeSpellChecker = false;
            });
        }
    });
    ...
    return {
        ...
        link: function (scope, elem, attrs) {
            ...
            var config = {
                ...
                readOnly: scope.ngDisabled ? scope.ngDisabled : false, allowedContent: true
            };
